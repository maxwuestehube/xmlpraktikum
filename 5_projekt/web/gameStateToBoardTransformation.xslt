...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="drawSeedsAndCount">
        ...
        <text x="{$x}" y="{$y}" fill="black"><xsl:value-of select="$index"/></text>
    ...
    <xsl:template match="MancalaGame">
        ...
        <svg xmlns:xlink="http://www.w3.org/1999/xlink"
            xmlns="http://www.w3.org/2000/svg" width="800px" height="400px">
            ...
            <defs>
                ...
                <g id="board">
                    ...
                    <!-- names of players, seeds in their kalahs  -->
                    ...
                    <xsl:for-each select="Player">
                        ...
                        <xsl:for-each select="PlayersHalf/House">
                            ...
                            <xsl:call-template name="drawSeedsAndCount">
                                ...
                                <xsl:with-param name="index"><xsl:value-of select="$houseIndex" /></xsl:with-param>
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:for-each>
